========================================================================
    APLICACIÓN DE CONSOLA: ExamenEstructuras2 Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación ExamenEstructuras2.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación ExamenEstructuras2.


ExamenEstructuras2.vcxproj
...
ExamenEstructuras2.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado ExamenEstructuras2.pch y un archivo de tipos precompilados llamado StdAfx.obj.
